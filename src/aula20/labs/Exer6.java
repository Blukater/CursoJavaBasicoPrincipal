...
char[][] jogoVelha = new char[3][3];
        ...
        int jogada = 1;
        char sinal;
        int linha = 0, coluna = 0; //Aqui mostrou que da pra declarar várias variáveis numa mesma linha
        ...
        while (!ganhou){
            ...
            if (jogada % 2 == 1){ // vez do jogador 1
                ...
                System.out.println("Vez do jogador 2. Escolha linha e coluna (1-3)."); // vez do jogador 2
                sinal = 'O';
            }
